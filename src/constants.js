...
export const FACETS_SETTINGS = {
  [IDs.EFFECTIVE_LOCATION_ID]: FACETS_OPTIONS.EFFECTIVE_LOCATION_OPTIONS,
  [IDs.LANGUAGES]: FACETS_OPTIONS.LANG_OPTIONS,
  [IDs.INSTANCE_TYPE_ID]: FACETS_OPTIONS.RESOURCE_TYPE_OPTIONS,
  [IDs.INSTANCE_FORMAT_ID]: FACETS_OPTIONS.FORMAT_OPTIONS,
  [IDs.MODE_OF_ISSUANCE_ID]: FACETS_OPTIONS.MODE_OF_ISSUANCE_OPTIONS,
  [IDs.NATURE_OF_CONTENT_TERM_IDS]: FACETS_OPTIONS.NATURE_OF_CONTENT_OPTIONS,
  [IDs.STAFF_SUPPRESS]: FACETS_OPTIONS.SUPPRESSED_OPTIONS,
  [IDs.INSTANCES_DISCOVERY_SUPPRESS]: FACETS_OPTIONS.INSTANCES_DISCOVERY_SUPPRESS_OPTIONS,
  [IDs.HOLDINGS_DISCOVERY_SUPPRESS_ID]: FACETS_OPTIONS.HOLDINGS_DISCOVERY_SUPPRESS_OPTIONS,
  [IDs.ITEMS_DISCOVERY_SUPPRESS_ID]: FACETS_OPTIONS.ITEMS_DISCOVERY_SUPPRESS_OPTIONS,
  [IDs.SOURCE]: FACETS_OPTIONS.SOURCE_OPTIONS,
  [IDs.INSTANCES_TAGS_ID]: FACETS_OPTIONS.INSTANCES_TAGS_OPTIONS,
  [IDs.HOLDINGS_TAGS_ID]: FACETS_OPTIONS.HOLDINGS_TAGS_OPTIONS,
  [IDs.ITEMS_TAGS_ID]: FACETS_OPTIONS.ITEMS_TAGS_OPTIONS,
  [IDs.MATERIAL_TYPES_ID]: FACETS_OPTIONS.MATERIAL_TYPES_OPTIONS,
  [IDs.ITEMS_STATUSES_ID]: FACETS_OPTIONS.ITEMS_STATUSES_OPTIONS,
  [IDs.HOLDINGS_PERMANENT_LOCATION_ID]: FACETS_OPTIONS.HOLDINGS_PERMANENT_LOCATION_OPTIONS,
};
